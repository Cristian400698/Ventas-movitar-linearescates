...
class MarketingDigitalController extends Controller
{
    /**
    ...
    public function index()
    {
        $z = 'NUEVO';
        $y = 'RECUPERADA';
        $markedigital = DB::table('markedigitals')
        ...
        return view('markedigital.index', compact('markedigital'));
    }
    ...
    public function create()
    {
        ...
        return view('markedigital.create', compact('hora', 'date', 'user_nombre', 'user_id', 'usuarios', 'Planadquieres', 'tipoclientes', 'origen'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('markedigital/create')->with('success', 'Datos guardados correctamente..');
    }
    ...
    {
        $markedigital = Markedigital::findOrFail($id);
        return view('markedigital.edit')->with('markedigital', $markedigital);
    }
    ...
    {
        $comunidad = Markedigital::find($id);
        ...
        return redirect('markedigital/index')->with('success', 'Datos guardados correctamente..');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('markedigital/index')->with('success', 'Datos Eliminado correctamente..');
    }
}
