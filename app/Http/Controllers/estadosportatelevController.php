...
class estadosportatelevController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('estadosportatelev.index', compact('portatelev','agente'));
    }
    ...
    public function searchmisventasportateleventas(Request $request)
    {
	$portatelev = portatelev::all();
        $searchtext = $request->get('text');
        $portatelev= portatelev::firstOrNew()
	...
	->paginate(20);
        ...
        return view('estadosportatelev.index',compact('portatelev'));
    }
}
