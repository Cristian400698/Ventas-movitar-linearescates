...
class migracionredesperdidaController extends Controller
{
    /**
    ...
    public function index()
    {
        $z ='PERDIDA'; 
        $y ='RECHAZADA';
        $migracionredesperdidas =DB::table('migracionredes')
        ...
        return view('migracionredesperdidas.index',compact('migracionredesperdidas'));
    }
