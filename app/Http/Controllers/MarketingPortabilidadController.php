...
class MarketingPortabilidadController extends Controller
{
    /**
    ...
    public function index()
    {
        $z = 'NUEVO';
        $y = 'RECUPERADA';
        $portabilidadrede = DB::table('marketportabilidads')
        ...
        return view('markeportabilidad.index', compact('portabilidadrede'));
    }
    ...
    public function create()
    {
        ...
        return view('markeportabilidad.create', compact('hora', 'date', 'user_nombre', 'user_id', 'usuarios', 'Planadquieres', 'tipoclientes', 'origen'));
    }
    ...
    {
        $portabilidadredes = new marketportabilidad();
        ...
        return redirect('markeportabilidad/create')->with('success', 'Datos guardados correctamente..');
    }
    ...
    {
        $portabilidadredes = marketportabilidad::findOrFail($id);
        return view('markeportabilidad.edit')->with('portabilidadredes', $portabilidadredes);
    }
    ...
    {
        $portabilidadredes = marketportabilidad::find($id);
        ...
        return redirect('markeportabilidad')->with('success', 'Datos guardados correctamente..');
    }
    ...
    public function searchmarkportabilidad(Request $request)
    {
        $portabilidadrede = marketportabilidad::all();
        $searchmarkportabilidad = $request->get('searchmarkportabilidad');
        $portabilidadrede = marketportabilidad::firstOrNew()
            ->where('Numero', 'like', '%' . $searchmarkportabilidad . '%')
            ->paginate(20);
