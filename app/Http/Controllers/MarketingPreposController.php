...
class MarketingPreposController extends Controller
{
    /**
    ...
    public function index()
    {
        $z = 'NUEVO';
        $y = 'RECUPERADA';
        $prepostredes = DB::table('marketpreposts')
            ...
            return view('markeprepos.index', compact('prepostredes'));
    }
    ...
    public function create()
    {
        ...
        return view('markeprepos.create', compact('hora', 'date', 'user_nombre', 'user_id', 'usuarios', 'Planadquieres', 'tipoclientes', 'origen'));
    ...
    {
        $prepostredes = new marketprepost();
        ...
        return redirect('markeprepos/create')->with('success', 'Datos guardados correctamente..');
    ...
    {
        $prepostredes = marketprepost::findOrFail($id);
        return view('markeprepos.edit')->with('prepostredes', $prepostredes);
    }
    ...
    {
        $prepostredes = marketprepost::find($id);
        ...
        $prepostredes->save();
         ...
         return redirect('markeprepos')->with('success', 'Datos guardados correctamente..');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('markeprepos')->with('success', 'Datos Eliminado correctamente..');
    }

    public function searchmarkeprepos(Request $request)
    {
        $z ='NUEVO'; 
        $y ='RECUPERADA';
        $texto = $request->get('searchmarkeprepos'); 
        $prepostredes = marketprepost::firstOrNew()
