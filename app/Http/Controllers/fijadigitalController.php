...
class fijadigitalController extends Controller
{
    ...
    public function index()
    {
        ...
        $z ='NUEVO'; 
        $y ='RECUPERADA';
        $fijadigital = fijadigital::all();
        $fijadigital = fijadigital::orderBy('dia', 'asc')
        ->Where('revisados', 'LIKE', $z )
        ->orWhere('revisados', 'LIKE', $y )
        ->paginate(20);
        return view('fijadigital.index',  compact('fijadigital'));
    }
    ...
    public function create()
    {
        ...
        return view('fijadigital.create', compact('hora','date','user_nombre','user_id','usuarios','estrato','producto','velocidad','tecnologia') );
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('fijadigital/create')->with('success', 'Datos guardados correctamente..');
    }
    ...
    public function edit($id)
    {
        ...
        return view('fijadigital.edit',compact('fijas'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('fijadigital')->with('success', 'Datos guardados correctamente..');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('fijadigital')->with('success', 'Datos Eliminado correctamente..');
    }
    public function searchdigifija(Request $request)
    {
	$fijadigital = fijadigital::all();
        $searchdigifija = $request->get('searchdigifija');
        $fijadigital = fijadigital::firstOrNew()->where('documento', 'like', '%'.$searchdigifija.'%')->paginate(20);
