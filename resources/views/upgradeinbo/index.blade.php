                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            @endif
                            <div class="col-md-6">
                                <form action="/searchinboundupgrade" method="GET">
                                    <div class="input-group">
                                        <input type="search" name="searchinboundupgrade" class="form-control">
                                ...
                                <div class="table-responsive">
                                        ...
                                        <tbody>
                                            @foreach ($upgradeinbo as $upgradeinbos)
                                                <tr style="text-align: center">
                                                    ...
                                                    <td>{{ $upgradeinbos->dia }} {{$upgradeinbos->hora}}</td>
                                                    <td class="td-actions text-right">

                                                        <a href="/upgradeinbo/{{ $upgradeinbos->id }}/edit"class="btn btn-info"><i
                                                                class="material-icons">edit</i></a>


                                                        <form action="{{ route('upgradeinbo.destroy',$upgradeinbos->id) }}"
                                    ...
                                    <p>
                                        ...
                                        <div class="col-md-6 mt-5">
                                         <form action="{{route('upgradeinbound.excel')}}">
                                         <div class="input-group">
