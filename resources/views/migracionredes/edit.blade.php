                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <form name="f1" action="{{ route('migracionredes.update', $migracionredes->id) }}" method="POST"
                                    ...
                                    <div class="form-row">
                                        <input type="hidden" name="agente" id="agente" value="{{ old('numero', $migracionredes->agente) }}">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="numero"
                                                ...
                                                value="{{ old('numero', $migracionredes->numero) }}"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="documento"
                                                ...
                                                value="{{ old('documento', $migracionredes->documento) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="nombres"
                                                ...
                                                value="{{ old('nombres', $migracionredes->nombres) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="apellidos"
                                                ...
                                                value="{{ old('apellidos', $migracionredes->apellidos) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="correo"
                                                ...
                                                value="{{ old('correo', $migracionredes->correo) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="selector"
                                                ...
                                                value="{{ old('selector', $migracionredes->selector) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="departamento"
                                                ...
                                                value="{{ old('departamento', $migracionredes->departamento) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="id_ciudad"
                                                ...
                                                value="{{ old('id_ciudad', $migracionredes->id_ciudad) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="barrio" style="color: black">Barrio</label>
                                            <input type="text" class="form-control-new" id="barrio"
                                                placeholder="barrio" name="barrio" value="{{ $migracionredes->barrio }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="direccion"
                                                ...
                                                value="{{ old('direccion', $migracionredes->direccion) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="nip"
                                                ...
                                                value="{{ old('nip', $migracionredes->nip) }}" style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="tipocliente"
                                                ...
                                                value="{{ old('tipocliente', $migracionredes->tipocliente) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="planadquiere"
                                                ...
                                                value="{{ old('planadquiere', $migracionredes->planadquiere) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="ncontacto"
                                                ...
                                                value="{{ old('ncontacto', $migracionredes->ncontacto) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="imei"
                                                ...
                                                value="{{ old('imei', $migracionredes->imei) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="ngrabacion"
                                                ...
                                                value="{{ old('ngrabacion', $migracionredes->ngrabacion) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fvc"
                                                ...
                                                value="{{ old('fvc', $migracionredes->fvc) }}" style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fentrega"
                                                ...
                                                value="{{ old('fentrega', $migracionredes->fentrega) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fexpedicion"
                                                ...
                                                value="{{ old('fexpedicion', $migracionredes->fexpedicion) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fnacimiento"
                                                ...
                                                value="{{ old('fnacimiento', $migracionredes->fnacimiento) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="origen"
                                                ...
                                                value="{{ old('origen', $migracionredes->origen) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="orden"
                                                ...
                                                value="{{ old('orden', $migracionredes->orden) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control-new" id="observaciones"
                                                ...
                                                value="{{ old('observaciones', $migracionredes->observaciones) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" name="confronta" id="confronta" value="{{ old('numero', $migracionredes->confronta) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="confronta" style="color: black;">Confronta</label><br>
                                                <a href="{{ asset('storage') . '/' . $migracionredes->confronta }}"><img
                                                        src="{{ asset('storage') . '/' . $migracionredes->confronta }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
                                        <input type="hidden" name="likewize" id="likewize" value="{{ old('numero', $migracionredes->likewize) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="likewize" style="color: black;">likewize</label><br>
                                                <a href="{{ asset('storage') . '/' . $migracionredes->likewize }}"><img
                                                        src="{{ asset('storage') . '/' . $migracionredes->likewize }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
                                        <input type="hidden" name="ley2300" id="ley2300" value="{{ old('numero', $migracionredes->ley2300) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="ley2300" style="color: black;">ley2300</label><br>
                                                <a href="{{ asset('storage') . '/' . $migracionredes->ley2300 }}"><img
                                                        src="{{ asset('storage') . '/' . $migracionredes->ley2300 }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
