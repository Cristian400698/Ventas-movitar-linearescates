                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            @endif
                            <div class="col-md-6">
                                <form action="/searchdigitalperdida" method="GET">
                                    <div class="input-group">
                                        <input type="search" name="searchdigitalperdida" class="form-control">
                                        ...
                                        <tbody>
                                            @foreach ($portadigital as $portadigitals)
                                                <tr style="text-align: center">
                                                    ...
                                                    <td>{{ $portadigitals->fvc }} {{$portadigitals->hora}}</td>
                                                    <td class="td-actions text-right">

                                                        <a href="/perdidaportadigital/{{ $portadigitals->id }}/edit"class="btn btn-info"><i
                                                                class="material-icons">edit</i></a>


                                                       <!--  <form action="{{ route('perdidaportadigital.destroy',$portadigitals->id) }}"
...
<p>
                                    ...
                                    <div class="col-md-6 mt-5">
                                        <form action="{{route('portadigital.excel')}}" method="GET">
                                            <div class="input-group">
