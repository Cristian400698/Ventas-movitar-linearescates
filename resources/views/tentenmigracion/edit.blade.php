                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <form name="f1" action="{{ route('tentenmigracion.update', $tentenmigracion->id) }}" method="POST"
                                    ...
                                    <div class="form-row">
                                        <input type="hidden" name="agente" id="agente" value="{{ old('numero', $tentenmigracion->agente) }}">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="numero"
                                                ...
                                                value="{{ old('numero', $tentenmigracion->numero) }}"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="documento"
                                                ...
                                                value="{{ old('documento', $tentenmigracion->documento) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="nombres"
                                                ...
                                                value="{{ old('nombres', $tentenmigracion->nombres) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="apellidos"
                                                ...
                                                value="{{ old('apellidos', $tentenmigracion->apellidos) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="correo"
                                                ...
                                                value="{{ old('correo', $tentenmigracion->correo) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="selector"
                                                ...
                                                value="{{ old('selector', $tentenmigracion->selector) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="departamento"
                                                ...
                                                value="{{ old('departamento', $tentenmigracion->departamento) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="id_ciudad"
                                                ...
                                                value="{{ old('id_ciudad', $tentenmigracion->id_ciudad) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="barrio" style="color: black">Barrio</label>
                                            <input type="text" class="form-control-new" id="barrio"
                                                placeholder="barrio" name="barrio" value="{{ $tentenmigracion->barrio }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="direccion"
                                                ...
                                                value="{{ old('direccion', $tentenmigracion->direccion) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="nip"
                                                ...
                                                value="{{ old('nip', $tentenmigracion->nip) }}" style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="tipocliente"
                                                ...
                                                value="{{ old('tipocliente', $tentenmigracion->tipocliente) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="planadquiere"
                                                ...
                                                value="{{ old('planadquiere', $tentenmigracion->planadquiere) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="ncontacto"
                                                ...
                                                value="{{ old('ncontacto', $tentenmigracion->ncontacto) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="imei"
                                                ...
                                                value="{{ old('imei', $tentenmigracion->imei) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="ngrabacion"
                                                ...
                                                value="{{ old('ngrabacion', $tentenmigracion->ngrabacion) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fvc"
                                                ...
                                                value="{{ old('fvc', $tentenmigracion->fvc) }}" style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fentrega"
                                                ...
                                                value="{{ old('fentrega', $tentenmigracion->fentrega) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fexpedicion"
                                                ...
                                                value="{{ old('fexpedicion', $tentenmigracion->fexpedicion) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fnacimiento"
                                                ...
                                                value="{{ old('fnacimiento', $tentenmigracion->fnacimiento) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="origen"
                                                ...
                                                value="{{ old('origen', $tentenmigracion->origen) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="orden"
                                                ...
                                                value="{{ old('orden', $tentenmigracion->orden) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control-new" id="observaciones"
                                                ...
                                                value="{{ old('observaciones', $tentenmigracion->observaciones) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" name="confronta" id="confronta" value="{{ old('numero', $tentenmigracion->confronta) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="confronta" style="color: black;">Confronta</label><br>
                                                <a href="{{ asset('storage') . '/' . $tentenmigracion->confronta }}"><img
                                                        src="{{ asset('storage') . '/' . $tentenmigracion->confronta }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
                                        <input type="hidden" name="likewize" id="likewize" value="{{ old('numero', $tentenmigracion->likewize) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="likewize" style="color: black;">likewize</label><br>
                                                <a href="{{ asset('storage') . '/' . $tentenmigracion->likewize }}"><img
                                                        src="{{ asset('storage') . '/' . $tentenmigracion->likewize }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
                                        <input type="hidden" name="ley2300" id="ley2300" value="{{ old('numero', $tentenmigracion->ley2300) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="ley2300" style="color: black;">ley2300</label><br>
                                                <a href="{{ asset('storage') . '/' . $tentenmigracion->ley2300 }}"><img
                                                        src="{{ asset('storage') . '/' . $tentenmigracion->ley2300 }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
