                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <form name="f1" action="{{ route('PerdidaTentenMigracion.update', $tentenmigracion->id) }}" method="POST"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12">
                                            <textarea class="form-control-new" id="obs2" name="obs2" rows="3"
                                                placeholder="Observaciones BackOficce" style="border-radius: 10px">{{ old('numero', $tentenmigracion->obs2) }}</textarea>
                                        </div>
