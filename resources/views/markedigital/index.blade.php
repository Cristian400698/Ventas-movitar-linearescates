    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-12">
                        <h6>Cantidad de Registros: {{ $markedigital->total() }}</h6>
                        <div class="card">
                            @if (session('success'))
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            @foreach ($markedigital as $comunidads)
                                            <tr style="text-align: center">
                                                ...
                                                <td class="td-actions text-right">
                                                    ...
                                                    <a href="/markedigital/{{ $comunidads->id }}/edit" class="btn btn-info"><i class="material-icons">edit</i></a>


                                                    <form action="{{ route('markedigital.destroy',$comunidads->id) }}" method="POST" style="display: inline-block;" onsubmit="return confirm('Esta seguro que desea eliminar el registro ?')">
                                                        @csrf
                                                        @method('DELETE')
