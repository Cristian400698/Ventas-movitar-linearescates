                            ...
                            <div class="table-responsive">
                                <form name="f1" action="{{ route('portatelev.update', $portatelev->id) }}" method="POST"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="marcador" style="color: black;">Marcador</label>
                                            <input type="text" class="form-control-new" id="origen"
                                                placeholder="marcador" name="marcador"
                                                value="{{ old('marcador', $portatelev->marcador) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-4">
                                        ...
                                        <input type="hidden" name="ley2300" id="ley2300" value="{{ old('numero', $portatelev->likewize) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="ley2300" style="color: black;">ley2300</label><br>
                                                <a href="{{ asset('storage') . '/' . $portatelev->ley2300 }}"><img
                                                        src="{{ asset('storage') . '/' . $portatelev->ley2300 }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
