@extends('layouts.main', ['activePage' => 'porta', 'titlePage' => 'BACKOFFICE PORTABILIDAD TELEVENTAS'])
@section('content')
<div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            @endif
                            <div class="col-md-6">
                                <form action="/searchteleventaback" method="GET">
                                    <div class="input-group">
                                        <input type="search" name="searchteleventaback" class="form-control">
                                ...
                                <div class="table-responsive">
                                        ...
                                        <tbody>
                                            @foreach ($portatelev as $portatelevs)
                                                <tr style="text-align: center">
                                                    ...
                                                    <td>{{ $portatelevs->dia }} {{$portatelevs->hora}}</td>
                                                    <td class="td-actions text-right">

                                                        <a href="/portatelev/{{ $portatelevs->id }}/edit"class="btn btn-info"><i
                                                                class="material-icons">edit</i></a>


                                                        <form action="{{ route('portatelev.destroy',$portatelevs->id) }}"
                                    ...
                                    <p>
                                        ...
                                        <div class="col-md-6 mt-5">
                                         <form action="{{route('portatelev.excel')}}">
                                         <div class="input-group">
