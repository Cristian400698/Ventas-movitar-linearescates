                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                @endif
                                <div class="col-md-6">
                                    <form action="/searchdigifija" method="GET">
                                        <div class="input-group">
                                            <input type="search" name="searchdigifija" class="form-control">
                                                ...
                                                @foreach ($fijadigital as $fijadigitals)
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-right">
                                                            ...
                                                            <a href="/fijadigital/{{ $fijadigitals->id }}/edit"class="btn btn-info"><i
                                                                    class="material-icons">edit</i></a>
    
    
                                                            <form action="{{ route('fijadigital.destroy',$fijadigitals->id) }}"
