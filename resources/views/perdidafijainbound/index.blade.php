@extends('layouts.main', ['activePage' => 'Fija', 'titlePage' => 'PERDIDAS FIJA INBOUND'])
@section('content')
    <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                @endif
                                <div class="col-md-6">
                                    <form action="/searchinboundperdidafija" method="GET">
                                        <div class="input-group">
                                            <input type="search" name="searchinboundperdidafija" class="form-control">
                                    ...
                                    <div class="table-responsive">
                                                ...
                                                @foreach ($fijainbound as $fijainbounds)
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-right">
                                                            ...
                                                            <a href="/perdidafijainbound/{{ $fijainbounds->id }}/edit"class="btn btn-info"><i
                                                                    class="material-icons">edit</i></a>
    
    
                                                          <!--   <form action="{{ route('perdidafijainbound.destroy',$fijainbounds->id) }}"
                                        ...
                                        {{--  @can('desacarga') --}}
                                            <div class="col-md-6 mt-5">
                                                <form action="{{route('fijainbound.excel')}}" method="GET">
                                                    <div class="input-group">
