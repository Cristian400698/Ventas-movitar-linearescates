                                        ...
                                        <div class="card-body">
                                            ...
                                            <div style="height:276px">
                                                ...
                                                <script>
                                                    ...
                                                    const config = {
                                                        type: 'bar',
                                                        data: data,plugins: [ChartDataLabels],
                options:{
                scales: {
                        xAxes: [{
                            barPercentage: 1.1,
                                ...
                                <script>
                                    ...
                                    var myPieChart = new Chart(ctx, {
                                        ...
                                        data: {
                                            ...
                                            datasets: [{
                                                label: '', 
                                                data: [ {{ $portdigs1 }}, {{ $portdigs2 }}, {{ $portdigs3 }}, {{ $portdigs4 }}, {{ $portdigs5 }}, {{ $portdigs6 }}, {{ $portdigs7 }}, {{ $portdigs8 }}, {{ $portdigs9 }}, {{ $portdigs10 }}, {{ $portdigs11 }}, {{ $portdigs12 }},
                                                            {{ $portdigs13 }}, {{ $portdigs14 }}, {{ $portdigs15 }}, {{ $portdigs16 }}, {{ $portdigs17 }}, {{ $portdigs18 }}, {{ $portdigs19 }}, {{ $portdigs20 }}, {{ $portdigs21 }}, {{ $portdigs22 }}, {{ $portdigs23 }}, {{ $portdigs24 }}, 
                                                            {{ $portdigs25 }}, {{ $portdigs26 }}, {{ $portdigs27 }}, {{ $portdigs28 }}, {{ $portdigs29 }}, {{ $portdigs30 }}, {{ $portdigs31 }},],
                                                backgroundColor: [
                                                    'rgba(255, 87, 87, 0.5)',
                                                    'rgba(255, 198, 87, 0.7)',
                                                    'rgba(87, 255, 87, 0.6)',
                                ...
                                <script>
                                    ...
                                    var myPieChart = new Chart(ctx, {
                                        ...
                                        data: {
                                            ...
                                            datasets: [{
                                                label: '',
                                                data: [ {{ $portelev1 }}, {{ $portelev2 }}, {{ $portelev3 }}, {{ $portelev4 }}, {{ $portelev5 }}, {{ $portelev6 }}, {{ $portelev7 }}, {{ $portelev8 }}, {{ $portelev9 }}, {{ $portelev10 }}, {{ $portelev11 }}, {{ $portelev12 }},
                                                        {{ $portelev13 }}, {{ $portelev14 }}, {{ $portelev15 }}, {{ $portelev16 }}, {{ $portelev17 }}, {{ $portelev18 }}, {{ $portelev19 }}, {{ $portelev20 }}, {{ $portelev21 }}, {{ $portelev22 }}, {{ $portelev23 }}, {{ $portelev24 }}, 
                                                        {{ $portelev25 }}, {{ $portelev26 }}, {{ $portelev27 }}, {{ $portelev28 }}, {{ $portelev29 }}, {{ $portelev30 }}, {{ $portelev31 }},],
                                                backgroundColor: [
                                                    'rgba(255, 87, 87, 0.5)',
                                                    'rgba(255, 198, 87, 0.7)',
                                                    'rgba(87, 255, 87, 0.6)',
                                ...
                                <script>
                                    ...
                                    var myPieChart = new Chart(ctx, {
                                        ...
                                        data: {
                                            ...
                                            datasets: [{
                                                label: '',
                                                data: [ {{ $upginbs1 }}, {{ $upginbs2 }}, {{ $upginbs3 }}, {{ $upginbs4 }}, {{ $upginbs5 }}, {{ $upginbs6 }}, {{ $upginbs7 }}, {{ $upginbs8 }}, {{ $upginbs9 }}, {{ $upginbs10 }}, {{ $upginbs11 }}, {{ $upginbs12 }},
                                                        {{ $upginbs13 }}, {{ $upginbs14 }}, {{ $upginbs15 }}, {{ $upginbs16 }}, {{ $upginbs17 }}, {{ $upginbs18 }}, {{ $upginbs19 }}, {{ $upginbs20 }}, {{ $upginbs21 }}, {{ $upginbs22 }}, {{ $upginbs23 }}, {{ $upginbs24 }}, 
                                                        {{ $upginbs25 }}, {{ $upginbs26 }}, {{ $upginbs27 }}, {{ $upginbs28 }}, {{ $upginbs29 }}, {{ $upginbs30 }}, {{ $upginbs31 }},],
                                                backgroundColor: [
                                                    'rgba(255, 87, 87, 0.5)',
                                                    'rgba(255, 198, 87, 0.7)',
                                                    'rgba(87, 255, 87, 0.6)',
                                ...
                                <script>
                                    ...
                                    var myPieChart = new Chart(ctx, {
                                        ...
                                        data: {
                                            ...
                                            datasets: [{
                                                label: '',
                                                data: [ {{ $upgradedigs1 }}, {{ $upgradedigs2 }}, {{ $upgradedigs3 }}, {{ $upgradedigs4 }}, {{ $upgradedigs5 }}, {{ $upgradedigs6 }}, {{ $upgradedigs7 }}, {{ $upgradedigs8 }}, {{ $upgradedigs9 }}, {{ $upgradedigs10 }}, {{ $upgradedigs11 }}, {{ $upgradedigs12 }},
                                                        {{ $upgradedigs13 }}, {{ $upgradedigs14 }}, {{ $upgradedigs15 }}, {{ $upgradedigs16 }}, {{ $upgradedigs17 }}, {{ $upgradedigs18 }}, {{ $upgradedigs19 }}, {{ $upgradedigs20 }}, {{ $upgradedigs21 }}, {{ $upgradedigs22 }}, {{ $upgradedigs23 }}, {{ $upgradedigs24 }}, 
                                                        {{ $upgradedigs25 }}, {{ $upgradedigs26 }}, {{ $upgradedigs27 }}, {{ $upgradedigs28 }}, {{ $upgradedigs29 }}, {{ $upgradedigs30 }}, {{ $upgradedigs31 }},],
                                                backgroundColor: [
                                                    'rgba(255, 87, 87, 0.5)',
                                                    'rgba(255, 198, 87, 0.7)',
                                                    'rgba(87, 255, 87, 0.6)',
                                ...
                                <script>
                                    ...
                                    var myPieChart = new Chart(ctx, {
                                        ...
                                        data: {
                                            ...
                                            datasets: [{
                                                label: '',
                                                data:  [ {{ $upgradetels1 }}, {{ $upgradetels2 }}, {{ $upgradetels3 }}, {{ $upgradetels4 }}, {{ $upgradetels5 }}, {{ $upgradetels6 }}, {{ $upgradetels7 }}, {{ $upgradetels8 }}, {{ $upgradetels9 }}, {{ $upgradetels10 }}, {{ $upgradetels11 }}, {{ $upgradetels12 }},
                                                        {{ $upgradetels13 }}, {{ $upgradetels14 }}, {{ $upgradetels15 }}, {{ $upgradetels16 }}, {{ $upgradetels17 }}, {{ $upgradetels18 }}, {{ $upgradetels19 }}, {{ $upgradetels20 }}, {{ $upgradetels21 }}, {{ $upgradetels22 }}, {{ $upgradetels23 }}, {{ $upgradetels24 }}, 
                                                        {{ $upgradetels25 }}, {{ $upgradetels26 }}, {{ $upgradetels27 }}, {{ $upgradetels28 }}, {{ $upgradetels29 }}, {{ $upgradetels30 }}, {{ $upgradetels31 }},],
                                                backgroundColor: [
                                                    'rgba(255, 87, 87, 0.5)',
                                                    'rgba(255, 198, 87, 0.7)',
                                                    'rgba(87, 255, 87, 0.6)',
                                ...
                                <script>
                                    ...
                                    var myPieChart = new Chart(ctx, {
                                        ...
                                        data: {
                                            ...
                                            datasets: [{
                                                label: '',
                                                data: [ {{ $preinbs1 }}, {{ $preinbs2 }}, {{ $preinbs3 }}, {{ $preinbs4 }}, {{ $preinbs5 }}, {{ $preinbs6 }}, {{ $preinbs7 }}, {{ $preinbs8 }}, {{ $preinbs9 }}, {{ $preinbs10 }}, {{ $preinbs11 }}, {{ $preinbs12 }},
                                                        {{ $preinbs13 }}, {{ $preinbs14 }}, {{ $preinbs15 }}, {{ $preinbs16 }}, {{ $preinbs17 }}, {{ $preinbs18 }}, {{ $preinbs19 }}, {{ $preinbs20 }}, {{ $preinbs21 }}, {{ $preinbs22 }}, {{ $preinbs23 }}, {{ $preinbs24 }}, 
                                                        {{ $preinbs25 }}, {{ $preinbs26 }}, {{ $preinbs27 }}, {{ $preinbs28 }}, {{ $preinbs29 }}, {{ $preinbs30 }}, {{ $preinbs31 }},],
                                                backgroundColor: [
                                                    'rgba(255, 87, 87, 0.5)',
                                                    'rgba(255, 198, 87, 0.7)',
                                                    'rgba(87, 255, 87, 0.6)',
                                ...
                                <script>
                                    ...
                                    var myPieChart = new Chart(ctx, {
                                        ...
                                        data: {
                                            ...
                                            datasets: [{
                                                label: '',
                                                data: [ {{ $predigs1 }}, {{ $predigs2 }}, {{ $predigs3 }}, {{ $predigs4 }}, {{ $predigs5 }}, {{ $predigs6 }}, {{ $predigs7 }}, {{ $predigs8 }}, {{ $predigs9 }}, {{ $predigs10 }}, {{ $predigs11 }}, {{ $predigs12 }},
                                                        {{ $predigs13 }}, {{ $predigs14 }}, {{ $predigs15 }}, {{ $predigs16 }}, {{ $predigs17 }}, {{ $predigs18 }}, {{ $predigs19 }}, {{ $predigs20 }}, {{ $predigs21 }}, {{ $predigs22 }}, {{ $predigs23 }}, {{ $predigs24 }}, 
                                                        {{ $predigs25 }}, {{ $predigs26 }}, {{ $predigs27 }}, {{ $predigs28 }}, {{ $predigs29 }}, {{ $predigs30 }}, {{ $predigs31 }},],
                                                backgroundColor: [
                                                    'rgba(255, 87, 87, 0.5)',
                                                    'rgba(255, 198, 87, 0.7)',
                                                    'rgba(87, 255, 87, 0.6)',
                                ...
                                <script>
                                    ...
                                    var myPieChart = new Chart(ctx, {
                                        ...
                                        data: {
                                            ...
                                            datasets: [{
                                                label: '',
                                                data: [ {{ $pretelv1 }}, {{ $pretelv2 }}, {{ $pretelv3 }}, {{ $pretelv4 }}, {{ $pretelv5 }}, {{ $pretelv6 }}, {{ $pretelv7 }}, {{ $pretelv8 }}, {{ $pretelv9 }}, {{ $pretelv10 }}, {{ $pretelv11 }}, {{ $pretelv12 }},
                                                        {{ $pretelv13 }}, {{ $pretelv14 }}, {{ $pretelv15 }}, {{ $pretelv16 }}, {{ $pretelv17 }}, {{ $pretelv18 }}, {{ $pretelv19 }}, {{ $pretelv20 }}, {{ $pretelv21 }}, {{ $pretelv22 }}, {{ $pretelv23 }}, {{ $pretelv24 }}, 
                                                        {{ $pretelv25 }}, {{ $pretelv26 }}, {{ $pretelv27 }}, {{ $pretelv28 }}, {{ $pretelv29 }}, {{ $pretelv30 }}, {{ $pretelv31 }},],
                                                backgroundColor: [
                                                    'rgba(255, 87, 87, 0.5)',
                                                    'rgba(255, 198, 87, 0.7)',
                                                    'rgba(87, 255, 87, 0.6)',
                                ...
                                <script>
                                    ...
                                    var myPieChart = new Chart(ctx, {
                                        ...
                                        data: {
                                            ...
                                            datasets: [{
                                                label: '',
                                                data: [ {{ $fijainbs1 }}, {{ $fijainbs2 }}, {{ $fijainbs3 }}, {{ $fijainbs4 }}, {{ $fijainbs5 }}, {{ $fijainbs6 }}, {{ $fijainbs7 }}, {{ $fijainbs8 }}, {{ $fijainbs9 }}, {{ $fijainbs10 }}, {{ $fijainbs11 }}, {{ $fijainbs12 }},
                                                        {{ $fijainbs13 }}, {{ $fijainbs14 }}, {{ $fijainbs15 }}, {{ $fijainbs16 }}, {{ $fijainbs17 }}, {{ $fijainbs18 }}, {{ $fijainbs19 }}, {{ $fijainbs20 }}, {{ $fijainbs21 }}, {{ $fijainbs22 }}, {{ $fijainbs23 }}, {{ $fijainbs24 }}, 
                                                        {{ $fijainbs25 }}, {{ $fijainbs26 }}, {{ $fijainbs27 }}, {{ $fijainbs28 }}, {{ $fijainbs29 }}, {{ $fijainbs30 }}, {{ $fijainbs31 }},],
                                                backgroundColor: [
                                                    'rgba(255, 87, 87, 0.5)',
                                                    'rgba(255, 198, 87, 0.7)',
                                                    'rgba(87, 255, 87, 0.6)',
                                ...
                                <script>
                                    ...
                                    var myPieChart = new Chart(ctx, {
                                        ...
                                        data: {
                                            ...
                                            datasets: [{
                                                label: '',
                                                data: [ {{ $fijadig1 }}, {{ $fijadig2 }}, {{ $fijadig3 }}, {{ $fijadig4 }}, {{ $fijadig5 }}, {{ $fijadig6 }}, {{ $fijadig7 }}, {{ $fijadig8 }}, {{ $fijadig9 }}, {{ $fijadig10 }}, {{ $fijadig11 }}, {{ $fijadig12 }},
                                                        {{ $fijadig13 }}, {{ $fijadig14 }}, {{ $fijadig15 }}, {{ $fijadig16 }}, {{ $fijadig17 }}, {{ $fijadig18 }}, {{ $fijadig19 }}, {{ $fijadig20 }}, {{ $fijadig21 }}, {{ $fijadig22 }}, {{ $fijadig23 }}, {{ $fijadig24 }}, 
                                                        {{ $fijadig25 }}, {{ $fijadig26 }}, {{ $fijadig27 }}, {{ $fijadig28 }}, {{ $fijadig29 }}, {{ $fijadig30 }}, {{ $fijadig31 }},],
                                                backgroundColor: [
                                                    'rgba(255, 87, 87, 0.5)',
                                                    'rgba(255, 198, 87, 0.7)',
                                                    'rgba(87, 255, 87, 0.6)',
                                ...
                                <script>
                                    ...
                                    var myPieChart = new Chart(ctx, {
                                        ...
                                        data: {
                                            ...
                                            datasets: [{
                                                label: '',
                                                data: [ {{ $fijatel1 }}, {{ $fijatel2 }}, {{ $fijatel3 }}, {{ $fijatel4 }}, {{ $fijatel5 }}, {{ $fijatel6 }}, {{ $fijatel7 }}, {{ $fijatel8 }}, {{ $fijatel9 }}, {{ $fijatel10 }}, {{ $fijatel11 }}, {{ $fijatel12 }},
                                                        {{ $fijatel13 }}, {{ $fijatel14 }}, {{ $fijatel15 }}, {{ $fijatel16 }}, {{ $fijatel17 }}, {{ $fijatel18 }}, {{ $fijatel19 }}, {{ $fijatel20 }}, {{ $fijatel21 }}, {{ $fijatel22 }}, {{ $fijatel23 }}, {{ $fijatel24 }}, 
                                                        {{ $fijatel25 }}, {{ $fijatel26 }}, {{ $fijatel27 }}, {{ $fijatel28 }}, {{ $fijatel29 }}, {{ $fijatel30 }}, {{ $fijatel31 }},],
                                                backgroundColor: [
                                                    'rgba(255, 87, 87, 0.5)',
                                                    'rgba(255, 198, 87, 0.7)',
                                                    'rgba(87, 255, 87, 0.6)',
                                        ...
                                        data: {
                                            ...
                                            datasets: [{
                                                ...
                                                data: [ {{ $ln1 }}, {{ $ln2 }}, {{ $ln3 }}, {{ $ln4 }}, {{ $ln5 }}, {{ $ln6 }}, {{ $ln7 }}, {{ $ln8 }}, {{ $ln9 }}, {{ $ln10 }}, {{ $ln11 }}, {{ $ln12 }},
                                                        {{ $ln13 }}, {{ $ln14 }}, {{ $ln15 }}, {{ $ln16 }}, {{ $ln17 }}, {{ $ln18 }}, {{ $ln19 }}, {{ $ln20 }}, {{ $ln21 }}, {{ $ln22 }}, {{ $ln23 }}, {{ $ln24 }}, 
                                                        {{ $ln25 }}, {{ $ln26 }}, {{ $ln27 }}, {{ $ln28 }}, {{ $ln29 }}, {{ $ln30 }}, {{ $ln31 }},],
                                                backgroundColor: [
                                                    'rgba(255, 87, 87, 0.5)',
                                                    'rgba(255, 198, 87, 0.7)',
                                                    'rgba(87, 255, 87, 0.6)',
                                ...
                                <script>
                                    ...
                                    var myPieChart = new Chart(ctx, {
                                        ...
                                        data: {
                                            ...
                                            datasets: [{
                                                label: '',
                                                data:  [ {{ $pho1 }}, {{ $pho2 }}, {{ $pho3 }}, {{ $pho4 }}, {{ $pho5 }}, {{ $pho6 }}, {{ $pho7 }}, {{ $pho8 }}, {{ $pho9 }}, {{ $pho10 }}, {{ $pho11 }}, {{ $pho12 }},
                                                        {{ $pho13 }}, {{ $pho14 }}, {{ $pho15 }}, {{ $pho16 }}, {{ $pho17 }}, {{ $pho18 }}, {{ $pho19 }}, {{ $pho20 }}, {{ $pho21 }}, {{ $pho22 }}, {{ $pho23 }}, {{ $pho24 }}, 
                                                        {{ $pho25 }}, {{ $pho26 }}, {{ $pho27 }}, {{ $pho28 }}, {{ $pho29 }}, {{ $pho30 }}, {{ $pho31 }},],
                                                backgroundColor: [
                                                    'rgba(255, 87, 87, 0.5)',
                                                    'rgba(255, 198, 87, 0.7)',
                                                    'rgba(87, 255, 87, 0.6)',
                            ...
                            <script>
                                ...
                                var myPieChart = new Chart(ctx, {
                                    ...
                                    data: {
                                        ...
                                        datasets: [{
                                            label: '',
                                            data: [{{$tenportas1}}, {{$tenportas2}}, {{$tenportas3}}, {{$tenportas4}}, {{$tenportas5}}, {{$tenportas6}}, {{$tenportas7}}, {{$tenportas8}},{{$tenportas9}}, {{$tenportas10}}, 
                                                 {{$tenportas11}}, {{$tenportas12}},{{$tenportas13}}, {{$tenportas14}}, {{$tenportas15}},{{$tenportas16}}, {{$tenportas17}}, {{$tenportas18}}, {{ $tenportas19}}, {{$tenportas20}}, 
                                                {{$tenportas21}}, {{$tenportas22}}, {{$tenportas23}}, {{$tenportas24}},{{$tenportas25}}, {{$tenportas26}}, {{$tenportas27}}, {{$tenportas28}}, {{$tenportas29}}, {{$tenportas30}},
                                                  {{$tenportas31}},],
                                            backgroundColor: [
                                                'rgba(255, 87, 87, 0.5)',
                                                'rgba(255, 198, 87, 0.7)',
                            ...
                            <script>
                                ...
                                var myPieChart = new Chart(ctx, {
                                    ...
                                    data: {
                                        ...
                                        datasets: [{
                                            label: '',
                                            data: [{{$tenmigras1}}, {{$tenmigras2}}, {{$tenmigras3}}, {{$tenmigras4}}, {{$tenmigras5}}, {{$tenmigras6}}, {{$tenmigras7}}, {{$tenmigras8}},{{$tenmigras9}}, {{$tenmigras10}}, 
                                                 {{$tenmigras11}}, {{$tenmigras12}},{{$tenmigras13}}, {{$tenmigras14}}, {{$tenmigras15}},{{$tenmigras16}}, {{$tenmigras17}}, {{$tenmigras18}}, {{ $tenmigras19}}, {{$tenmigras20}}, 
                                                {{$tenmigras21}}, {{$tenmigras22}}, {{$tenmigras23}}, {{$tenmigras24}},{{$tenmigras25}}, {{$tenmigras26}}, {{$tenmigras27}}, {{$tenmigras28}}, {{$tenmigras29}}, {{$tenmigras30}},
                                                  {{$tenmigras31}},],
                                            backgroundColor: [
                                                'rgba(255, 87, 87, 0.5)',
                                                'rgba(255, 198, 87, 0.7)',
                            ...
                            <script>
                                ...
                                var myPieChart = new Chart(ctx, {
                                    ...
                                    data: {
                                        ...
                                        datasets: [{
                                            label: '',
                                            data: [{{$tenprepos1}}, {{$tenprepos2}}, {{$tenprepos3}}, {{$tenprepos4}}, {{$tenprepos5}}, {{$tenprepos6}}, {{$tenprepos7}}, {{$tenprepos8}},{{$tenprepos9}}, {{$tenprepos10}}, 
                                                 {{$tenprepos11}}, {{$tenprepos12}},{{$tenprepos13}}, {{$tenprepos14}}, {{$tenprepos15}},{{$tenprepos16}}, {{$tenprepos17}}, {{$tenprepos18}}, {{ $tenprepos19}}, {{$tenprepos20}}, 
                                                {{$tenprepos21}}, {{$tenprepos22}}, {{$tenprepos23}}, {{$tenprepos24}},{{$tenprepos25}}, {{$tenprepos26}}, {{$tenprepos27}}, {{$tenprepos28}}, {{$tenprepos29}}, {{$tenprepos30}},
                                                  {{$tenprepos31}},],
                                            backgroundColor: [
                                                'rgba(255, 87, 87, 0.5)',
                                                'rgba(255, 198, 87, 0.7)',
                            ...
                            <script>
                                ...
                                var myPieChart = new Chart(ctx, {
                                    ...
                                    data: {
                                        ...
                                        datasets: [{
                                            label: '',
                                            data: [{{$migracionredes1}}, {{$migracionredes2}}, {{$migracionredes3}}, {{$migracionredes4}}, {{$migracionredes5}}, {{$migracionredes6}}, {{$migracionredes7}}, {{$migracionredes8}},{{$migracionredes9}}, {{$migracionredes10}}, 
                                                {{$migracionredes11}}, {{$migracionredes12}},{{$migracionredes13}}, {{$migracionredes14}}, {{$migracionredes15}},{{$migracionredes16}}, {{$migracionredes17}}, {{$migracionredes18}}, {{ $migracionredes19}}, {{$migracionredes20}}, 
                                                {{$migracionredes21}}, {{$migracionredes22}}, {{$migracionredes23}}, {{$migracionredes24}},{{$migracionredes25}}, {{$migracionredes26}}, {{$migracionredes27}}, {{$migracionredes28}}, {{$migracionredes29}}, {{$migracionredes30}},
                                                {{$migracionredes31}},],
                                            backgroundColor: [
                                                'rgba(255, 87, 87, 0.5)',
                                                'rgba(255, 198, 87, 0.7)',
                            ...
                            <script>
                                ...
                                var myPieChart = new Chart(ctx, {
                                    ...
                                    data: {
                                        ...
                                        datasets: [{
                                            label: '',
                                            data: [{{$portabilidadredes1}}, {{$portabilidadredes2}}, {{$portabilidadredes3}}, {{$portabilidadredes4}}, {{$portabilidadredes5}}, {{$portabilidadredes6}}, {{$portabilidadredes7}}, {{$portabilidadredes8}},{{$portabilidadredes9}}, {{$portabilidadredes10}}, 
                                                {{$portabilidadredes11}}, {{$portabilidadredes12}},{{$portabilidadredes13}}, {{$portabilidadredes14}}, {{$portabilidadredes15}},{{$portabilidadredes16}}, {{$portabilidadredes17}}, {{$portabilidadredes18}}, {{ $portabilidadredes19}}, {{$portabilidadredes20}}, 
                                                {{$portabilidadredes21}}, {{$portabilidadredes22}}, {{$portabilidadredes23}}, {{$portabilidadredes24}},{{$portabilidadredes25}}, {{$portabilidadredes26}}, {{$portabilidadredes27}}, {{$portabilidadredes28}}, {{$portabilidadredes29}}, {{$portabilidadredes30}},
                                                {{$portabilidadredes31}},],
                                            backgroundColor: [
                                                'rgba(255, 87, 87, 0.5)',
                                                'rgba(255, 198, 87, 0.7)',
                            ...
                            <script>
                                ...
                                var myPieChart = new Chart(ctx, {
                                    ...
                                    data: {
                                        ...
                                        datasets: [{
                                            label: '',
                                            data: [{{$prepostredes1}}, {{$prepostredes2}}, {{$prepostredes3}}, {{$prepostredes4}}, {{$prepostredes5}}, {{$prepostredes6}}, {{$prepostredes7}}, {{$prepostredes8}},{{$prepostredes9}}, {{$prepostredes10}}, 
                                                {{$prepostredes11}}, {{$prepostredes12}},{{$prepostredes13}}, {{$prepostredes14}}, {{$prepostredes15}},{{$prepostredes16}}, {{$prepostredes17}}, {{$prepostredes18}}, {{ $prepostredes19}}, {{$prepostredes20}}, 
                                                {{$prepostredes21}}, {{$prepostredes22}}, {{$prepostredes23}}, {{$prepostredes24}},{{$prepostredes25}}, {{$prepostredes26}}, {{$prepostredes27}}, {{$prepostredes28}}, {{$prepostredes29}}, {{$prepostredes30}},
                                                {{$prepostredes31}},],
                                            backgroundColor: [
                                                'rgba(255, 87, 87, 0.5)',
                                                'rgba(255, 198, 87, 0.7)',
