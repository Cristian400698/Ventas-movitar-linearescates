        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form name="f1" action="{{ route('perdidaupgradeinbound.update', $upgradeinbo->id) }}" method="POST"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <textarea class="form-control-new" id="obs2" name="obs2" rows="3"
                                            placeholder="Observaciones BackOficce" style="border-radius: 10px">{{ old('orden', $upgradeinbo->obs2) }}</textarea>
                                    </div>
                                </div>
