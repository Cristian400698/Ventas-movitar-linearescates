            ...
            <div class="row">
                <div class="col-md-12">
                    <center>
                        ...
                        <h3 aline="center">Editar Gestion de Phoenix Marketing</h3>
                    </center>
                    <div class="card">
                        <div class="card-body">
                            <form name="f1" action="{{ route('markephoenix.update', $phoenixes->id) }}" method="POST"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control-new" id="direccion" placeholder="direccion" name="direccion"
                                            value="{{ old('direccion', $phoenixes->direccion) }}" style="border-radius: 10px">
                                    </div>
                                    <div class="form-group col-md-6">
