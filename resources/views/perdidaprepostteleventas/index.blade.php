                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                @endif
                                <div class="col-md-6">
                                    <form action="/searchteleperdidaprepost" method="GET">
                                        <div class="input-group">
                                            <input type="search" name="searchteleperdidaprepost" class="form-control">
                                ...
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                @foreach ($preposteleventa as $preposteleventas)
                                                    <tr>
                                                        ...
                                                        <td>{{ $preposteleventas->created_at }}</td>  
                                                            <td class="td-actions text-right">
                                                                <a
                                                                href="/perdidaprepostteleventa/{{ $preposteleventas->id }}/edit"class="btn btn-info"><i
                                                                    class="material-icons">edit</i></a>

                                                            <!-- <form action="{{ route('perdidaprepostteleventa.destroy', $preposteleventas->id) }}"
                                    ...
                                    <div class="col-md-6 mt-5">
                                        <form action="{{route('prepostteleventa.excel')}}" method="GET">
                                            <div class="input-group">
