            ...
            <div class="row">
                <div class="col-md-12">
                    <center>
                        ...
                        <h3 aline="center">Redes Sociales Portabilidad</h3>
                    </center>
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <form name="f1" action="{{ route('portabilidadredes.update', $portabilidadredes->id) }}" method="POST"
                                    ...
                                    <div class="form-row">
                                        <input type="hidden" name="agente" id="agente" value="{{ old('numero', $portabilidadredes->agente) }}">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="numero"
                                                ...
                                                value="{{ old('numero', $portabilidadredes->numero) }}"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="documento"
                                                ...
                                                value="{{ old('documento', $portabilidadredes->documento) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="nombres"
                                                ...
                                                value="{{ old('nombres', $portabilidadredes->nombres) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="apellidos"
                                                ...
                                                value="{{ old('apellidos', $portabilidadredes->apellidos) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="correo"
                                                ...
                                                value="{{ old('correo', $portabilidadredes->correo) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="selector"
                                                ...
                                                value="{{ old('selector', $portabilidadredes->selector) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="departamento"
                                                ...
                                                value="{{ old('departamento', $portabilidadredes->departamento) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="id_ciudad"
                                                ...
                                                value="{{ old('id_ciudad', $portabilidadredes->id_ciudad) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="barrio" style="color: black">Barrio</label>
                                            <input type="text" class="form-control-new" id="barrio"
                                                placeholder="barrio" name="barrio" value="{{ $portabilidadredes->barrio }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="direccion"
                                                ...
                                                value="{{ old('direccion', $portabilidadredes->direccion) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="nip"
                                                ...
                                                value="{{ old('nip', $portabilidadredes->nip) }}" style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="tipocliente"
                                                ...
                                                value="{{ old('tipocliente', $portabilidadredes->tipocliente) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="planadquiere"
                                                ...
                                                value="{{ old('planadquiere', $portabilidadredes->planadquiere) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="ncontacto"
                                                ...
                                                value="{{ old('ncontacto', $portabilidadredes->ncontacto) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="imei"
                                                ...
                                                value="{{ old('imei', $portabilidadredes->imei) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="ngrabacion"
                                                ...
                                                value="{{ old('ngrabacion', $portabilidadredes->ngrabacion) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fvc"
                                                ...
                                                value="{{ old('fvc', $portabilidadredes->fvc) }}" style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fentrega"
                                                ...
                                                value="{{ old('fentrega', $portabilidadredes->fentrega) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fexpedicion"
                                                ...
                                                value="{{ old('fexpedicion', $portabilidadredes->fexpedicion) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fnacimiento"
                                                ...
                                                value="{{ old('fnacimiento', $portabilidadredes->fnacimiento) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="origen"
                                                ...
                                                value="{{ old('origen', $portabilidadredes->origen) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="orden"
                                                ...
                                                value="{{ old('orden', $portabilidadredes->orden) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control-new" id="observaciones"
                                                ...
                                                value="{{ old('observaciones', $portabilidadredes->observaciones) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" name="confronta" id="confronta" value="{{ old('numero', $portabilidadredes->confronta) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="confronta" style="color: black;">Confronta</label><br>
                                                <a href="{{ asset('storage') . '/' . $portabilidadredes->confronta }}"><img
                                                        src="{{ asset('storage') . '/' . $portabilidadredes->confronta }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
                                        <input type="hidden" name="likewize" id="likewize" value="{{ old('numero', $portabilidadredes->likewize) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="likewize" style="color: black;">likewize</label><br>
                                                <a href="{{ asset('storage') . '/' . $portabilidadredes->likewize }}"><img
                                                        src="{{ asset('storage') . '/' . $portabilidadredes->likewize }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
                                        <input type="hidden" name="ley2300" id="ley2300" value="{{ old('numero', $portabilidadredes->ley2300) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="ley2300" style="color: black;">ley2300</label><br>
                                                <a href="{{ asset('storage') . '/' . $portabilidadredes->ley2300 }}"><img
                                                        src="{{ asset('storage') . '/' . $portabilidadredes->ley2300 }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
