@extends('layouts.main', ['activePage' => 'porta', 'titlePage' => 'PERDIDAS PORTABILIDAD INBOUND'])
@section('content')
<div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            @endif
                            <div class="col-md-6">
                                <form action="/searchinboundperdida" method="GET">
                                    <div class="input-group">
                                        <input type="search" name="searchinboundperdida" class="form-control">
                                        ...
                                        <tbody>
                                            @foreach ($portainbound as $portainbounds)
                                                <tr style="text-align: center">
                                                    ...
                                                    <td>{{ $portainbounds->fvc }} {{$portainbounds->hora}}</td>
                                                    <td class="td-actions text-right">

                                                        <a href="/perdidaportainbound/{{ $portainbounds->id }}/edit"class="btn btn-info"><i
                                                                class="material-icons">edit</i></a>


                                                     {{--    <form action="{{ route('perdidaportainbound.destroy',$portainbounds->id) }}"
                            ...
                            <form action="{{route('portainbound.excel')}}" method="GET">
                                <div class="input-group">
