        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form name="f1" action="{{ url('/upgradetelev/' . $upgradetelev->id) }}" method="POST"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <span>
                                            <a href="{{ asset('storage') . '/' . $upgradetelev->likewize }}"><img
                                                    src="{{ asset('storage') . '/' . $upgradetelev->likewize }}"
                                                    alt="" height="130" width="260"
                                                    style="border-radius: 10px"></a>
                                        </span>
                                    </div>
                                    <div class="form-group col-md-4">
                                        ...
                                        <span>
                                            <a href="{{ asset('storage') . '/' . $upgradetelev->ley2300 }}"><img
                                                    src="{{ asset('storage') . '/' . $upgradetelev->ley2300 }}"
                                                    alt="" height="130" width="260"
                                                    style="border-radius: 10px"></a>
                                        </span>
                                    </div>
