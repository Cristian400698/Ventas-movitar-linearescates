            ...
            <div class="row">
                <div class="col-md-12">
                    <center>
                        ...
                        <h3 aline="center">Redes Sociales Prepost</h3>
                    </center>
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <form name="f1" action="{{ route('prepostredes.update', $prepostredes->id) }}" method="POST"
                                    ...
                                    <div class="form-row">
                                        <input type="hidden" name="agente" id="agente" value="{{ old('numero', $prepostredes->agente) }}">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="numero"
                                                ...
                                                value="{{ old('numero', $prepostredes->numero) }}"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="documento"
                                                ...
                                                value="{{ old('documento', $prepostredes->documento) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="nombres"
                                                ...
                                                value="{{ old('nombres', $prepostredes->nombres) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="apellidos"
                                                ...
                                                value="{{ old('apellidos', $prepostredes->apellidos) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="correo"
                                                ...
                                                value="{{ old('correo', $prepostredes->correo) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="selector"
                                                ...
                                                value="{{ old('selector', $prepostredes->selector) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="departamento"
                                                ...
                                                value="{{ old('departamento', $prepostredes->departamento) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="id_ciudad"
                                                ...
                                                value="{{ old('id_ciudad', $prepostredes->id_ciudad) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="barrio" style="color: black">Barrio</label>
                                            <input type="text" class="form-control-new" id="barrio"
                                                placeholder="barrio" name="barrio" value="{{ $prepostredes->barrio }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="direccion"
                                                ...
                                                value="{{ old('direccion', $prepostredes->direccion) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="nip"
                                                ...
                                                value="{{ old('nip', $prepostredes->nip) }}" style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="tipocliente"
                                                ...
                                                value="{{ old('tipocliente', $prepostredes->tipocliente) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="planadquiere"
                                                ...
                                                value="{{ old('planadquiere', $prepostredes->planadquiere) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="ncontacto"
                                                ...
                                                value="{{ old('ncontacto', $prepostredes->ncontacto) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="imei"
                                                ...
                                                value="{{ old('imei', $prepostredes->imei) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="ngrabacion"
                                                ...
                                                value="{{ old('ngrabacion', $prepostredes->ngrabacion) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fvc"
                                                ...
                                                value="{{ old('fvc', $prepostredes->fvc) }}" style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fentrega"
                                                ...
                                                value="{{ old('fentrega', $prepostredes->fentrega) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fexpedicion"
                                                ...
                                                value="{{ old('fexpedicion', $prepostredes->fexpedicion) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fnacimiento"
                                                ...
                                                value="{{ old('fnacimiento', $prepostredes->fnacimiento) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="origen"
                                                ...
                                                value="{{ old('origen', $prepostredes->origen) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="orden"
                                                ...
                                                value="{{ old('orden', $prepostredes->orden) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control-new" id="observaciones"
                                                ...
                                                value="{{ old('observaciones', $prepostredes->observaciones) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" name="confronta" id="confronta" value="{{ old('numero', $prepostredes->confronta) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="confronta" style="color: black;">Confronta</label><br>
                                                <a href="{{ asset('storage') . '/' . $prepostredes->confronta }}"><img
                                                        src="{{ asset('storage') . '/' . $prepostredes->confronta }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
                                        <input type="hidden" name="likewize" id="likewize" value="{{ old('numero', $prepostredes->likewize) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="likewize" style="color: black;">likewize</label><br>
                                                <a href="{{ asset('storage') . '/' . $prepostredes->likewize }}"><img
                                                        src="{{ asset('storage') . '/' . $prepostredes->likewize }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
                                        <input type="hidden" name="ley2300" id="ley2300" value="{{ old('numero', $prepostredes->ley2300) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="ley2300" style="color: black;">ley2300</label><br>
                                                <a href="{{ asset('storage') . '/' . $prepostredes->ley2300 }}"><img
                                                        src="{{ asset('storage') . '/' . $prepostredes->ley2300 }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
