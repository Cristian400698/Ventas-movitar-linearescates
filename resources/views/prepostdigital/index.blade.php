@extends('layouts.main', ['activePage' => 'Prepost', 'titlePage' => 'BACKOFFICE PREPOST DIGITAL'])
@section('content')
    <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                @endif
                                <div class="col-md-6">
                                    <form action="/searchdigiprepost" method="GET">
                                        <div class="input-group">
                                            <input type="search" name="searchdigiprepost" class="form-control">
                                    ...
                                    <div class="table-responsive">
                                            ...
                                            <tbody>
                                                @foreach ($prepostdigital as $prepostdigitals)
                                                    <tr>
                                                        ...
                                                        <td>{{ $prepostdigitals->dia }} {{ $prepostdigitals->hora }}</td>   
                                                            <td class="td-actions text-right">
                                                                <a
                                                                href="/prepostdigital/{{ $prepostdigitals->id }}/edit"class="btn btn-info"><i
                                                                    class="material-icons">edit</i></a>

                                                            <form action="{{ route('prepostdigital.destroy', $prepostdigitals->id) }}"
                                        ...
                                        <p>
                                            ...
                                            <div class="col-md-6 mt-5">
                                             <form action="{{route('prepostdigital.excel')}}">
