@extends('layouts.main', ['activePage' => 'Fija', 'titlePage' => 'PERDIDAS FIJA TELEVENTA'])
@section('content')
    <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                @endif
                                <div class="col-md-6">
                                    <form action="/searchteleperdidafija" method="GET">
                                        <div class="input-group">
                                            <input type="search" name="searchteleperdidafija" class="form-control">
                                    ...
                                    <div class="table-responsive">
                                                ...
                                                @foreach ($fijateleventa as $fijateleventas)
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-right">
                                                            ...
                                                            <a href="/perdidafijateleventa/{{ $fijateleventas->id }}/edit"class="btn btn-info"><i
                                                                    class="material-icons">edit</i></a>
    
    
                                                           <!--  <form action="{{ route('perdidafijateleventa.destroy',$fijateleventas->id) }}"
                                        ...
                                        {{--  @can('desacarga') --}}
                                            <div class="col-md-6 mt-5">
                                                <form action="{{route('fijateleventa.excel')}}" method="GET">
                                                    <div class="input-group">
