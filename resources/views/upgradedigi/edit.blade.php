                            ...
                            <form name="f1" action="{{ url('/upgradedigi/' . $upgradedigi->id) }}" method="POST"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <span>
                                            <a href="{{ asset('storage') . '/' . $upgradedigi->likewize }}"><img
                                                    src="{{ asset('storage') . '/' . $upgradedigi->likewize }}"
                                                    alt="" height="130" width="260"
                                                    style="border-radius: 10px"></a>
                                        </span>
                                    </div>
                                    <div class="form-group col-md-4">
                                        ...
                                        <span>
                                            <a href="{{ asset('storage') . '/' . $upgradedigi->ley2300 }}"><img
                                                    src="{{ asset('storage') . '/' . $upgradedigi->ley2300 }}"
                                                    alt="" height="130" width="260"
                                                    style="border-radius: 10px"></a>
                                        </span>
                                    </div>
