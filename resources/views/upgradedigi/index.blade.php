@extends('layouts.main', ['activePage' => 'Upgrade', 'titlePage' => 'BACKOFFICE UPGRADE DIGITAL'])
@section('content')
<div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            @endif
                            <div class="col-md-6">
                                <form action="/searchdigiupgrade" method="GET">
                                    <div class="input-group">
                                        <input type="search" name="searchdigiupgrade" class="form-control">
                                ...
                                <div class="table-responsive">
                                        ...
                                        <tbody>
                                            @foreach ($upgradedigi as $upgradedigis)
                                                <tr style="text-align: center">
                                                    ...
                                                    <td>{{ $upgradedigis->dia }} {{$upgradedigis->hora}}</td>
                                                    <td class="td-actions text-right">

                                                        <a href="/upgradedigi/{{ $upgradedigis->id }}/edit"class="btn btn-info"><i
                                                                class="material-icons">edit</i></a>


                                                        <form action="{{ route('upgradedigi.destroy',$upgradedigis->id) }}"
                                    ...
                                    <p>
                                        ...
                                        <div class="col-md-6 mt-5">
                                         <form action="{{route('upgradedigital.excel')}}">
                                         <div class="input-group">
