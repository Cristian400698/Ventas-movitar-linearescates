                            ...
                            <div class="table-responsive">
                                <form name="f1" action="{{ route('portadigital.update', $portadigital->id) }}" method="POST"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <input type="hidden" name="likewize" id="likewize" value="{{ old('numero', $portadigital->likewize) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="likewize" style="color: black;">likewize</label><br>
                                                <a href="{{ asset('storage') . '/' . $portadigital->likewize }}"><img
                                                        src="{{ asset('storage') . '/' . $portadigital->likewize }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
                                        <input type="hidden" name="ley2300" id="ley2300" value="{{ old('numero', $portadigital->ley2300) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="ley2300" style="color: black;">ley2300</label><br>
                                                <a href="{{ asset('storage') . '/' . $portadigital->ley2300 }}"><img
                                                        src="{{ asset('storage') . '/' . $portadigital->ley2300 }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
