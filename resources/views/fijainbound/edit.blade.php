...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form name="f1" action="{{ route('fijainbound.update', $fijas->id) }}" method="POST"
        ...
        <script>
            ...
            let tp2 = ['Ok',
                        'PCO Bloqueado por el mes','No aprueba PCO',
                        'Sin Complementos - No Cobertura','Políticas de Agendamiento','Información incompleta - No hay detalle de oferta','Oferta errada',
                        'Orden en Proceso','Posible Fraude','Venta con QT','Datos Incompletos en el Gestor','Datos Incompletos en el Gestor (No Confronta)',
                        'Segmento errado','Dirección errada','Carrusel',
            ...
            $revisados.addEventListener('change', function () {
                ...
                switch (valor) {  
                    case 'OK':
                        ...
                        break
                    case 'RECUPERAR':
                        recortar(tp2, 1, 3, $estadorevisado)
                        break
                    case 'PERDIDA':
                        recortar(tp2, 3, 16, $estadorevisado)
                        break    
                }
