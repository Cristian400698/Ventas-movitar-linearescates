@extends('layouts.main', ['activePage' => 'Fija', 'titlePage' => 'PERDIDAS FIJA DIGITAL'])
@section('content')
    <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                @endif
                                <div class="col-md-6">
                                    <form action="/searchdigiperdidafija" method="GET">
                                        <div class="input-group">
                                            <input type="search" name="searchdigiperdidafija" class="form-control">
                                    ...
                                    <div class="table-responsive">
                                                ...
                                                @foreach ($fijadigital as $fijadigitals)
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-right">
                                                            ...
                                                            <a href="/perdidafijadigital/{{ $fijadigitals->id }}/edit"class="btn btn-info"><i
                                                                    class="material-icons">edit</i></a>
    
    
                                                         <!--    <form action="{{ route('perdidafijadigital.destroy',$fijadigitals->id) }}"
                                        ...
                                        {{--  @can('desacarga') --}}
                                            <div class="col-md-6 mt-5">
                                                <form action="{{route('fijadigital.excel')}}" method="GET">
                                                    <div class="input-group">
