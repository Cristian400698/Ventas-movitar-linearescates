                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <form name="f1" action="{{ route('tentenportabilidad.update', $tentenportabilidad->id) }}" method="POST"
                                    ...
                                    <div class="form-row">
                                        <input type="hidden" name="agente" id="agente" value="{{ old('numero', $tentenportabilidad->agente) }}">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="numero"
                                                ...
                                                value="{{ old('numero', $tentenportabilidad->numero) }}"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="documento"
                                                ...
                                                value="{{ old('documento', $tentenportabilidad->documento) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="nombres"
                                                ...
                                                value="{{ old('nombres', $tentenportabilidad->nombres) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="apellidos"
                                                ...
                                                value="{{ old('apellidos', $tentenportabilidad->apellidos) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="correo"
                                                ...
                                                value="{{ old('correo', $tentenportabilidad->correo) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="selector"
                                                ...
                                                value="{{ old('selector', $tentenportabilidad->selector) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="departamento"
                                                ...
                                                value="{{ old('departamento', $tentenportabilidad->departamento) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="id_ciudad"
                                                ...
                                                value="{{ old('id_ciudad', $tentenportabilidad->id_ciudad) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="barrio" style="color: black">Barrio</label>
                                            <input type="text" class="form-control-new" id="barrio"
                                                placeholder="barrio" name="barrio" value="{{ $tentenportabilidad->barrio }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" 
                                                ...
                                                value="{{ old('direccion', $tentenportabilidad->direccion) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="nip"
                                                ...
                                                value="{{ old('nip', $tentenportabilidad->nip) }}" style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="tipocliente"
                                                ...
                                                value="{{ old('tipocliente', $tentenportabilidad->tipocliente) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="planadquiere"
                                                ...
                                                value="{{ old('planadquiere', $tentenportabilidad->planadquiere) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="ncontacto"
                                                ...
                                                value="{{ old('ncontacto', $tentenportabilidad->ncontacto) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="imei"
                                                ...
                                                value="{{ old('imei', $tentenportabilidad->imei) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="ngrabacion"
                                                ...
                                                value="{{ old('ngrabacion', $tentenportabilidad->ngrabacion) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fvc"
                                                ...
                                                value="{{ old('fvc', $tentenportabilidad->fvc) }}" style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fentrega"
                                                ...
                                                value="{{ old('fentrega', $tentenportabilidad->fentrega) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fexpedicion"
                                                ...
                                                value="{{ old('fexpedicion', $tentenportabilidad->fexpedicion) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control-new" id="fnacimiento"
                                                ...
                                                value="{{ old('fnacimiento', $tentenportabilidad->fnacimiento) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control-new" id="origen"
                                                ...
                                                value="{{ old('origen', $tentenportabilidad->origen) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control-new" id="orden"
                                                ...
                                                value="{{ old('orden', $tentenportabilidad->orden) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control-new" id="observaciones"
                                                ...
                                                value="{{ old('observaciones', $tentenportabilidad->observaciones) }}"
                                                style="border-radius: 10px">
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" name="confronta" id="confronta" value="{{ old('numero', $tentenportabilidad->confronta) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="confronta" style="color: black;">Confronta</label><br>
                                                <a href="{{ asset('storage') . '/' . $tentenportabilidad->confronta }}"><img
                                                        src="{{ asset('storage') . '/' . $tentenportabilidad->confronta }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
                                        <input type="hidden" name="likewize" id="likewize" value="{{ old('numero', $tentenportabilidad->likewize) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="likewize" style="color: black;">likewize</label><br>
                                                <a href="{{ asset('storage') . '/' . $tentenportabilidad->likewize }}"><img
                                                        src="{{ asset('storage') . '/' . $tentenportabilidad->likewize }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
                                        <input type="hidden" name="ley2300" id="ley2300" value="{{ old('numero', $tentenportabilidad->ley2300) }}">
                                        <div class="form-group col-md-4">
                                            <span><label for="ley2300" style="color: black;">ley2300</label><br>
                                                <a href="{{ asset('storage') . '/' . $tentenportabilidad->ley2300 }}"><img
                                                        src="{{ asset('storage') . '/' . $tentenportabilidad->ley2300 }}"
                                                        alt="" height="130" width="300"
                                                        style="border-radius: 10px"></a>
                                            </span>
                                        </div>
